...
fn combinations() {
    ...
    assert!((1..3).unique_combinations(5).next().is_none());
    ...
    it::assert_equal((0..0).unique_combinations(2), <Vec<Vec<_>>>::new());
    it::assert_equal((0..1).unique_combinations(1), vec![vec![0]]);
    it::assert_equal((0..2).unique_combinations(1), vec![vec![0], vec![1]]);
    it::assert_equal((0..2).unique_combinations(2), vec![vec![0, 1]]);
}
...
fn combinations_of_too_short() {
    ...
    for i in 1..10 {
        assert!((0..0).unique_combinations(i).next().is_none());
        assert!((0..i - 1).unique_combinations(i).next().is_none());
    }
}
