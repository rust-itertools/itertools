...
pub mod structs {
    ...
    #[cfg(feature = "use_std")]
    pub use crate::unique_combinations::UniqueCombinations;
    #[cfg(feature = "use_std")]
...
pub trait Itertools: Iterator {
    ...
    /// use itertools::Itertools;
    ///
    /// let it = vec![1, 2, 2].into_iter().unique_combinations(2);
    /// itertools::assert_equal(it, vec![
    ///     vec![1, 2],
    ///     vec![2, 2],
    ///     ]);
    /// ```
    #[cfg(feature = "use_std")]
    fn unique_combinations(self, k: usize) -> UniqueCombinations<Self>
    where
        Self: Sized,
        Self::Item: Clone + Ord,
    {
        unique_combinations::unique_combinations(self, k)
    }
